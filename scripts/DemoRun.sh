...
export BootstrapSSHTool="https://raw.githubusercontent.com/allthingsclowd/BootstrapCertificateTool/0.0.26/scripts/Generate_Access_Certificates.sh"
export BootstrapSSHToolCA="https://raw.githubusercontent.com/allthingsclowd/BootstrapCertificateTool/0.0.26/scripts/BootstrapCAs.sh"
