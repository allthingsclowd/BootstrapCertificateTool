...
export BootStrapCertTool="https://raw.githubusercontent.com/allthingsclowd/BootstrapCertificateTool/move_to_env_vars/scripts/Generate_PKI_Certificates_For_Lab.sh"
