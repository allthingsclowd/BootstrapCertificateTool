...
#export BootStrapCertTool="https://raw.githubusercontent.com/allthingsclowd/BootstrapCertificateTool/AdjustNamingConvention/scripts/Generate_PKI_Certificates_For_Lab.sh"
