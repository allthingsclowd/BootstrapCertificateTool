...
# export BootStrapCertTool="https://raw.githubusercontent.com/allthingsclowd/BootstrapCertificateTool/allthingsclowd-patch-1/scripts/Generate_PKI_Certificates_For_Lab.sh"
